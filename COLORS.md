...
Unified color scheme for terminal workflow. All 28 unique colors extracted and verified from actual configuration files.
...
| Color                 | Hex       | RGB             | Usage                               |
|-----------------------|-----------|-----------------|-------------------------------------|
| **Deep Blue**         | `#0066FF` | `0, 102, 255`   | String literals, constants, hyperlinks |
...
- **Functions:** `#68D5FF` (blue) / **Strings:** `#0066FF` (deep blue)
...
**UI Elements:**
| Element | Hex | Color Name | Opacity |
|---------|-----|------------|---------|
| Background | `#000000` | Black | 100% |
| Foreground | `#FFFFFF` | White | 100% |
| Bold | `#FFFFFF` | White | 100% |
| Selection | `#C6A7FF` | Purple | 100% |
| Selected Text | `#000000` | Black | 100% |
| Cursor | `#FFFFFF` | White | 100% |
| Cursor Text | `#000000` | Black | 100% |
| Link | `#0066FF` | Deep Blue | 100% |
